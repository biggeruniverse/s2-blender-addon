...
class Vec3:
	...
	def max(self, other):
		return Vec3(max(self.data[0], other.data[0]), max(self.data[1], other.data[1]), max(self.data[2], other.data[2]))

	def min(self, other):
		return Vec3(min(self.data[0], other.data[0]), min(self.data[1], other.data[1]), min(self.data[2], other.data[2]))
